#!/usr/bin/env python3
"""Retraction tests for heal_build_sequence_advancer_heartbeat.py (slice 1 pilot).
...
Run:
    python3 -m unittest scripts.tests.test_heal_build_sequence_advancer_retraction
"""
...
class _IsolatedQueue(unittest.TestCase):
    ...
    def _seed_stale_escalate(self):
        ok = larry_alerts.append_alert(
            ...
            message='advancer heartbeat stale', subject=h.ALERT_SUBJECT,
            route='escalate',
        )
        self.assertTrue(ok)
