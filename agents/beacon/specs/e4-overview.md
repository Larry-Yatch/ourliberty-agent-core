...
| Supabase project ownership | **`agent.beacon.ourliberty@gmail.com`** | Consistent with E5 separation (agent-OS as tenant separate from personal). Billing visible to the agent identity, not Larry's personal Google. |
