...
## G-rule outbox-notifier-auto-merge-queue-stale-merged-pr-001 — **2/3** (updated iter ~4702)

**Rule:** outbox-notifier fires `auto_merge_queue_stale` alert for PRs in the AUTO_MERGE queue held >24h — but the named PR is already MERGED. The notifier's stale-entry check does not verify PR state before alerting. Fix: before firing `auto_merge_queue_stale`, check if the queued PR is already MERGED/CLOSED and clean the queue entry silently if so. Dispatch to Beacon at 3/3. Occurrences: iter ~4696 (PR #840, MERGED 03:09:42Z, alert fired 02:36:27Z 2026-07-09); iter ~4702 (PR #843, MERGED 2026-07-08T02:04:55Z, stale queue alert fired 03:09:56Z 2026-07-09, bot route=hold); iter ~4721 (PR #853, govern-loop-assessor-spec-001, HELD behind PR #860 >24h alert at 05:30:16Z; PR #853 not in open-PR list → suspected MERGED; GH rate limit prevented verification this iter; UNVERIFIED — confirm + dispatch to Beacon next iter).

---

## Status snapshot — updated 2026-07-09T05:40Z UTC (Iter ~4721, **Tier 1**)

**Iter ~4721 summary (2026-07-09T05:40Z):** ⚠️ 2 new alerts. Line 1046 auto_merge_queue_stale PR #853 Tier-4 (bot DM'd Larry idx=1045; PR #853 not in open list → suspected MERGED stale-queue; G-rule 3/3 unverified GH rate-limit); line 1047 stalled-active-step Tier-3 silence. GH rate-limit burst 4× PR #847 recheck (300s backoff clearing ~05:41Z). PR #890 Mirror REVIEW_REVISION; revision-1 → Forge inbox. Watermark=1047. **STANDING:** zombie PID 1834248 (~41d+10h+17m+); PR #847 OPEN (held_deep_review); PR #854 OPEN PREFLIGHT_EXIT; PR #853 state unverified; PR #860/874/889/890/891 OPEN; PR #891 Mirror reviewing; PR #890 revision-1 in Forge; PR #889 revision-1 in Forge; VI/VIII proposals idx=990,991 awaiting Larry; APPROVAL_REQUEST outbox-notifier-pending-auto-merge-queue-001 awaiting Larry. PRIME: ratio≈22.1 (interventions≈1633, systemic_fixes=74, vp=35). **ACTIVE G-rules:** outbox-notifier-auto-merge-queue-stale-merged-pr-001 [potential 3/3 unverified]; build-sequence-advancer-sequence-complete-tier4-001 [2/3]; forge-marker-task-id-mismatch-xii-v1 [2/3]; pr-fanout-probe-health-tier4-001 [1/3]; outbox-notifier-merge-held-deep-review-tier4-001 [1/3]; mirror-malformed-verdict-heal-reap-path-001 [1/3]; forge-wip-redispatch-genuine-no-pr-001 [1/3]; forge-wip-redispatch-exhausted-genuine-no-pr-001 [1/3]; sentinel-inflight-stall-tier4 [VP, fix=PR #854]; notifier-concurrent-scan-dup (PR #847 held); ourliberty-health-subject-key-mismatch-001 [3/3, vp]; forge-revision-preamble-missing-pr711-001 [VP]; unreviewed-merge-larry-authored-pr-001 [13+]; forge-wip-redispatch-digest-tier4-001 [vp]; auto-merge-conflict-promoted-merged-pr-001 [DISPATCHED ✅ → vp]; outbox-notifier-auto-merge-rate-limit-orphan-001 [DISPATCHED ✅ 3/3 → vp]. **VERIFIED (closed):** sequence-invalid-completeness-pr3-fanout-sentinel (PR #871); no-session-revision-merged-pr-fp-001 (PR #873); notifier-gh-rate-limit-no-backoff-001 (PR #880 ✅); heal-pipeline-stall-stalled-active-step-tier4-001 (PR #883 ✅).
