...
## G-rule heal-unregistered-approval-null-chat-id-001 — 2/3 (updated iter ~5094)

**Rule:** Pending approvals created with `chat_id=0/null` — DM not delivered via the approval path. Doorbell recovers the gap (~9-min delay) in both known occurrences. Fix: approval creators should populate `chat_id` from Larry's known chat_id (7998341473). Dispatch to Beacon at 3/3. Occurrences: iter ~4865 (unreg-approval-f5079f4c5369 via heal_unregistered_approval.py, PR #854 stranded escalation, chat_id=null); iter ~5094 (gh-burn-phase2-durable-fix-authorize via gh-burn analysis path, chat_id=0, doorbell L882 recovered at 13:10:28Z, Pulse compensating alert L883 sent redundantly).
...
## Status snapshot — updated 2026-07-11T14:44Z UTC (Iter ~5105, **Tier 1**, consecutive_clean=0)

**Iter ~5105 summary (2026-07-11T14:44Z):** Non-clean. 1 new alert: L887 `source=ourliberty-health, subject="ourliberty-agent-core health: 1 issue(s) need attention"` — Tier 4 per helper (G-rule ourliberty-health-subject-key-mismatch-001 post-3/3-dispatch, vp; direction-ask dispatched iter ~4488 has NOT landed). Bot DM'd Larry idx=886 at 14:42:46Z UTC; no Pulse DM (duplicate). Zombie PID 1834248 (43d+19h+22m); pending=1 gh-burn-phase2-durable-fix-authorize (doorbell 13:11:58Z, no Larry response); PR #860 OPEN/UNKNOWN; Check XI 18.8% over gate. HEAD=1c6ad2eb=origin/main. ratio=~18.97 (86 systemic_fixes / ~1631 interventions; 33 vp). **ACTIVE G-rules:** outbox-notifier-merge-conflict-manual-rebase-tier4-001 [2/3]; forge-wip-redispatch-exhausted-genuine-no-pr-001 [2/3]; outbox-notifier-notification-intent-review-escalate-tier4-001 [2/3]; outbox-notifier-auto-merge-stale-revalidation-tier4-001 [2/3]; heal-unregistered-approval-null-chat-id-001 [2/3]; mirror-malformed-verdict-heal-reap-path-001 [1/3]; mirror-queue-wait-gauge-tier4-001 [1/3]; inbox-watcher-tier-pool-all-unavailable-tier4-001 [1/3]; heal-pipeline-stall-unrouted-deep-review-required-fp-001 [1/3]; heal-pulse-check-staleness-single-flight-skip-fp-001 [1/3]; gate-parallelism-monitor-regression-data-001 [1/3]; pulse-rotation-check-source-tier4-001 [1/3]; watermark-rotation-gap [1/3 iter ~5063]; ourliberty-health-subject-key-mismatch-001 [3/3, vp — stale fix, still Tier 4]; forge-revision-preamble-missing-pr711-001 [vp]; forge-wip-redispatch-digest-tier4-001 [vp]; forge-wip-redispatch-exhausted-pr-exists-fp-001 [APPROVAL_REQUEST QUEUED iter ~3279, vp]; decision-needed-approval-forge-dispatch-no-target-repo-001 [vp]; no-session-revision-active-mirror-session-fp-001 [vp].
