...
**CORRECTED elapsed-time calculation (iter ~9922, 2026-08-27T06:09Z UTC):** Iters ~9884–~9921 incorrectly stated "~255h elapsed" from the 2026-08-17T23:23:16Z UTC last_dm. Correct elapsed at 06:09Z UTC is ~223h (not 255h — a ~32h overcount propagated from an arithmetic error). Similarly, "~6d+ overdue" was wrong — rotation was ~5d overdue at that time. ALWAYS verify elapsed by computing directly from pulse-rotation-window-dms.json last_dm, not by carrying the prior iter's number forward.
