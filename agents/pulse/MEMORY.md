...
- **Steady-state degraded hold: 19 consecutive iters (377–395) with 0 new alerts, 0 new escalations, 0 new G-rule occurrences.** Awaiting Larry action on APPROVAL_REQUEST `Tier 2 OAuth restore`.
