...
## G-rule watermark-rotation-gap — 1/3 (new, iter ~5063)

**Rule:** `repair-watermark` returned `repaired=true` (old_watermark=1027, file_length=1026, new_watermark=1026). The retention/compaction job removed 1 line from `larry-alerts.jsonl`, leaving watermark 1 ahead of file length. repair-watermark auto-healed it and the suppression entry was logged to `~/agents/state/pulse-fixture-suppressions.jsonl`. Per spec § 3.0, this is auto-handled and journals only. If this recurs (2+/3), consider whether the compaction cadence and watermark-advance ordering need a tighter transactional lock (e.g., advance watermark only AFTER confirming file_length hasn't shrunk since last read). First occurrence iter ~5063.

---

## Status snapshot — updated 2026-07-11T17:01Z UTC (Iter ~5122, **Tier 1**, consecutive_clean=0)

**Iter ~5122 summary (2026-07-11T17:01Z):** 1 G-rule dispatch (3/3). PR #930 (sync-push-fail-persistence-gate-dedup-001) MERGED 16:57:52Z UTC. PR #932 (notifier-auto-retraction-rollout-spec-001) OPEN/MERGEABLE, Mirror review in progress since 10:57:25 MDT. PR #931 (chore: dismiss proposed mission routing-approvals-escalations-on-a-null-chat-id) OPEN/UNKNOWN, no auto-review label, Beacon-authored. Zombie PID 1834248 (43d+21h+38m); pending=0; Check XI 18.8% over gate. watermark=891. HEAD=05bf2d3e (origin/main advanced with PR #930 merge — wrapper fast-forwards). ratio=19.14 (85 systemic_fixes / 1627 interventions; 34 vp; ledger ground truth). **ACTIVE G-rules:** heal-unregistered-approval-null-chat-id-001 [3/3, DISPATCHED ✅ iter ~5122, vp]; outbox-notifier-merge-conflict-manual-rebase-tier4-001 [2/3]; forge-wip-redispatch-exhausted-genuine-no-pr-001 [2/3]; outbox-notifier-notification-intent-review-escalate-tier4-001 [2/3]; outbox-notifier-auto-merge-stale-revalidation-tier4-001 [2/3]; mirror-malformed-verdict-heal-reap-path-001 [1/3]; mirror-queue-wait-gauge-tier4-001 [1/3]; inbox-watcher-tier-pool-all-unavailable-tier4-001 [1/3]; heal-pipeline-stall-unrouted-deep-review-required-fp-001 [1/3]; heal-pulse-check-staleness-single-flight-skip-fp-001 [1/3]; gate-parallelism-monitor-regression-data-001 [1/3]; pulse-rotation-check-source-tier4-001 [1/3]; watermark-rotation-gap [1/3 iter ~5063]; ourliberty-health-subject-key-mismatch-001 [3/3, vp]; forge-revision-preamble-missing-pr711-001 [vp]; forge-wip-redispatch-digest-tier4-001 [vp]; forge-wip-redispatch-exhausted-pr-exists-fp-001 [APPROVAL_REQUEST QUEUED iter ~3279, vp]; decision-needed-approval-forge-dispatch-no-target-repo-001 [vp]; no-session-revision-active-mirror-session-fp-001 [vp].
