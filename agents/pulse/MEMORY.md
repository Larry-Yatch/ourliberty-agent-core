...
- **Steady-state degraded hold: 69 consecutive iters (377–445) with 0 new G-rule advances.** Iter 445: 0 new escalations, 0 new G-rule advances. PR #238 OPEN (Check X). Awaiting Larry action on APPROVAL_REQUEST `Tier 2 OAuth restore`. Cooldown files PLATEAU confirmed (293/27 — unchanged 3 iters; natural expiry paused; will self-correct when OAuth restored).
