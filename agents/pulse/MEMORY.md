...
**Rule:** outbox-notifier fires `auto_merge_queue_stale` alert for PRs in the AUTO_MERGE queue held >24h — but the named PR is already MERGED. The notifier's stale-entry check does not verify PR state before alerting. Fix: before firing `auto_merge_queue_stale`, check if the queued PR is already MERGED/CLOSED and clean the queue entry silently if so. Dispatch to Beacon at 3/3. Occurrences: iter ~4696 (PR #840, MERGED 03:09:42Z, alert fired 02:36:27Z 2026-07-09); iter ~4702 (PR #843, MERGED 2026-07-08T02:04:55Z, stale queue alert fired 03:09:56Z 2026-07-09, bot route=hold).

---

## Status snapshot — updated 2026-07-09T04:43Z UTC (Iter ~4713, **Tier 1**)

**Iter ~4713 summary (2026-07-09T04:43Z):** PR #887 MERGED ✅ (rate-limit cleared ~04:41Z; Pulse gh pr merge recovery). Forge completed promoter-pr-state-gate-001 round-2 → PR #889 OPEN (Mirror sent revision-1 to Forge inbox). pr2-slot-aware-healers PROCEED → build dispatched to Forge inbox. PR #888 (hermetic-gh flake-C) queued for Mirror review. APPROVAL_REQUEST outbox-notifier-pending-auto-merge-queue-001 delivered to Larry (Beacon processed direction-ask in 4 min). 2 alerts triaged Tier-3. Watermark=1044. All daemons nominal. **STANDING:** zombie PID 1834248 (~41d+09h+); PR #847 OPEN (held_deep_review); PR #854 OPEN PREFLIGHT_EXIT; PR #860/874 OPEN; PR #888 OPEN (Mirror reviewing); PR #889 OPEN (revision-1 pending Forge); VI/VIII proposals idx=990,991 awaiting Larry; APPROVAL_REQUEST outbox-notifier-pending-auto-merge-queue-001 awaiting Larry; forge-wip-redispatch EXHAUSTED for review-sequence-dag-suite-green-guardian; Forge inbox: revision-promoter-pr-state-gate-001-1.json + build-pr2-slot-aware-healers.json. PRIME: ratio≈22.04 (interventions≈1632, systemic_fixes=74, vp=35), trend worsening. **ACTIVE G-rules:** outbox-notifier-auto-merge-queue-stale-merged-pr-001 [2/3]; build-sequence-advancer-sequence-complete-tier4-001 [2/3]; forge-marker-task-id-mismatch-xii-v1 [2/3]; pr-fanout-probe-health-tier4-001 [1/3]; outbox-notifier-merge-held-deep-review-tier4-001 [1/3]; forge-wip-redispatch-exhausted-genuine-no-pr-001 [1/3]; mirror-malformed-verdict-heal-reap-path-001 [1/3]; sentinel-inflight-stall-tier4 [VP, fix=PR #854]; notifier-concurrent-scan-dup (PR #847 held); ourliberty-health-subject-key-mismatch-001 [3/3, vp]; forge-revision-preamble-missing-pr711-001 [VP]; unreviewed-merge-larry-authored-pr-001 [13+]; forge-wip-redispatch-digest-tier4-001 [vp]; auto-merge-conflict-promoted-merged-pr-001 [DISPATCHED ✅ → vp]; **outbox-notifier-auto-merge-rate-limit-orphan-001 [DISPATCHED ✅ 3/3 → vp; PR #887 instance recovered ✅]**. **VERIFIED (closed):** sequence-invalid-completeness-pr3-fanout-sentinel (PR #871); no-session-revision-merged-pr-fp-001 (PR #873); notifier-gh-rate-limit-no-backoff-001 (PR #880 ✅); heal-pipeline-stall-stalled-active-step-tier4-001 (PR #883 ✅).
