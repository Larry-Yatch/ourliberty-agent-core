...
## G-rule outbox-notifier-auto-merge-queue-stale-merged-pr-001 — 1/3 (new, iter ~4696)

**Rule:** outbox-notifier fires `auto_merge_queue_stale` alert when a PR in the AUTO_MERGE queue has been HELD behind a blocker for >24h. But the PR (#840) was already MERGED (2026-07-08T03:09:42Z) at alert time. The notifier's stale-entry check does not verify PR state before alerting. Fix: before firing `auto_merge_queue_stale`, check if the queued PR is already MERGED/CLOSED and clean the queue entry silently if so. First occurrence iter ~4696 (PR #840, MERGED 03:09:42Z, alert fired 02:36:27Z UTC 2026-07-09 saying it was held since 02:36:24Z 2026-07-08). Dispatch to Beacon at 3/3.

---

## Status snapshot — updated 2026-07-09T03:07Z UTC (Iter ~4700, **Tier 1**)

**Iter ~4700 summary (2026-07-09T03:07Z):** 1 new larry-alerts.jsonl entry (doorbell Tier-3, watermark advanced 1033→1034). Dashboard PR #120 MERGED (03:05:22Z, Mirror REVIEW_PASS auto-merge). PR #885 `feat(system-health): honest resource signals + reliable watcher` (agent-core) + PR #121 `feat(system-health): honest verdict-led gauge` (dashboard) opened and dispatched to Mirror (21:05Z). PR #884 REVIEW_ESCALATE doorbell confirmed delivered 21:03:24 MDT. `mirror-two-slot-review-001` ACTIVE: `pr1-slot-plumbing` still in Forge build (~14 min). Mirror inbox: 2 items (PR #885 + PR #121 reviews). All daemons nominal (beacon=315127, inbox_watcher=316040, outbox_notifier=314403). Sync last_sync=02:38:59Z (~27 min, threshold ~04:39Z). **STANDING:** zombie PID 1834248 (~41d+07h+46m); PR #884 REVIEW_ESCALATE pending; PR #847 OPEN UNKNOWN (held_deep_review); PR #854 OPEN PREFLIGHT_EXIT; PR #860 OPEN UNKNOWN; PR #874 OPEN UNKNOWN; VI/VIII proposals idx=990,991 awaiting Larry; forge-wip-redispatch EXHAUSTED for review-sequence-dag-suite-green-guardian. PRIME: ratio≈21.92 (interventions≈1623, systemic_fixes=74, vp=34), trend worsening. **ACTIVE G-rules:** outbox-notifier-auto-merge-queue-stale-merged-pr-001 [1/3]; build-sequence-advancer-sequence-complete-tier4-001 [2/3]; outbox-notifier-merge-held-deep-review-tier4-001 [1/3]; pr-fanout-probe-health-tier4-001 [1/3]; forge-wip-redispatch-exhausted-genuine-no-pr-001 [1/3]; outbox-notifier-auto-merge-rate-limit-orphan-001 [1/3]; sentinel-inflight-stall-tier4 [VP, fix=PR #854]; notifier-concurrent-scan-dup (PR #847 held); auto-merge-conflict-promoted-merged-pr-001 [2/3]; forge-marker-task-id-mismatch-xii-v1 [2/3]; ourliberty-health-subject-key-mismatch-001 [3/3, vp]; mirror-malformed-verdict-heal-reap-path-001 [1/3]; forge-revision-preamble-missing-pr711-001 [VP]; unreviewed-merge-larry-authored-pr-001 [12+]; forge-wip-redispatch-digest-tier4-001 [vp]. **VERIFIED (closed):** sequence-invalid-completeness-pr3-fanout-sentinel (PR #871); no-session-revision-merged-pr-fp-001 (PR #873); notifier-gh-rate-limit-no-backoff-001 (PR #880 ✅); heal-pipeline-stall-stalled-active-step-tier4-001 (PR #883 ✅).
