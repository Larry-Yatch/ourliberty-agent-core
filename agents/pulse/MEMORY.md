...
- **Steady-state degraded hold: 60 consecutive iters (377–436) with 0 new escalations, 0 new G-rule advances.** 2 Tier 3 (FYI) stuck-timer alerts at iter 397 — both auto-healed. 0 new alerts at iters 398–436. Awaiting Larry action on APPROVAL_REQUEST `Tier 2 OAuth restore`.
